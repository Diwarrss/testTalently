...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleAddNewTask: function handleAddNewTask() {
      ...
      axios.post("/api/v1/tasks", this.newTask).then(function (res) {
        _this.$toaster.success("Task add successfully"); // Tell the parent component we've added a new task and include it
    ...
    handleUpdateTask: function handleUpdateTask() {
      var _this2 = this;
      ...
      axios.put("/api/v1/tasks/".concat(this.newTask.id), this.newTask).then(function (_ref) {
        var data = _ref.data;

        _this2.$toaster.success(data.msg);

        _this2.$emit("task-added", data.task, true);

        _this2.$emit("task-canceled");
      })["catch"](function (err) {
        // Handle the error returned from our request
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    taskInitials: function taskInitials() {
      /**Get task for get movedTask */
      var allTasks = [];
      this.statuses.map(function (st) {
        return st.tasks.map(function (task) {
          return allTasks.push("".concat(st.slug, "-").concat(st.id, "-").concat(task.id, "-").concat(task.order));
        });
      });
      return allTasks;
    }
  ...
  created: function created() {
    window.axios.defaults.headers.common["Authorization"] = "Bearer ".concat(this.$store.state.auth.token);
    this.getStatuses();
  },
  watch: {
    taskInitials: function taskInitials(newVal, oldVal) {
      /**Return moved task*/
      var old = oldVal;
      var yung = newVal;
      var movedTask = yung.filter(function (y) {
        return !old.includes(y);
      });
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios.get("/api/v1/statuses").then(function (_ref) {
                  var data = _ref.data;
                  _this.statuses = data;

                  _this.$store.commit("status/SET_STATUSES", data);
                })["catch"](function (_ref2) {
                  var data = _ref2.response.data;

                  _this.$toaster.error(data.message);
                });
    ...
    validateDate: function validateDate(date_delivery) {
      var todayDate = moment__WEBPACK_IMPORTED_MODULE_1___default()().format("YYYY-MM-DD");
      moment__WEBPACK_IMPORTED_MODULE_1___default()(date_delivery);
    ...
    openEditTaskForm: function openEditTaskForm(task) {
    ...
    handleTaskAdded: function handleTaskAdded(newTask) {
      ...
      if (edit) {
        ...
        var index = this.statuses[statusIndex].tasks.findIndex(function (e) {
          return e.id === newTask.id;
        });
    ...
    handleTaskMoved: function handleTaskMoved() {
      ...
      var movedTask = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

      // Send the moved task to the server
      if (movedTask.length) {
        if (movedTask.includes("done")) this.$toaster.success("Felicitaciones por lograrlo!");
        axios.put("/api/v1/tasks/sync", {
          movedTask: movedTask
        }).then(function (_ref3) {
          var data = _ref3.data;

          _this2.$store.commit("status/SET_STATUSES", data.tasks);
        })["catch"](function (err) {
          _this2.$toaster.error(err.response);
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.status-drag[data-v-2cc81914] {\n  transition: transform 0.5s;\n  transition-property: all;\n}\n.card-draggable[data-v-2cc81914] {\n  cursor: move;\n}\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_KanbanBoard_vue_vue_type_style_index_0_id_2cc81914_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_KanbanBoard_vue_vue_type_style_index_0_id_2cc81914_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/pages/KanbanBoard.vue":
/*!********************************************!*\
  !*** ./resources/js/pages/KanbanBoard.vue ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _KanbanBoard_vue_vue_type_template_id_2cc81914_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true& */ "./resources/js/pages/KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true&");
/* harmony import */ var _KanbanBoard_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./KanbanBoard.vue?vue&type=script&lang=js& */ "./resources/js/pages/KanbanBoard.vue?vue&type=script&lang=js&");
/* harmony import */ var _KanbanBoard_vue_vue_type_style_index_0_id_2cc81914_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css& */ "./resources/js/pages/KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _KanbanBoard_vue_vue_type_template_id_2cc81914_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _KanbanBoard_vue_vue_type_template_id_2cc81914_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "2cc81914",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/KanbanBoard.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/pages/KanbanBoard.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/pages/KanbanBoard.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/pages/KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css&":
/*!*****************************************************************************************************!*\
  !*** ./resources/js/pages/KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css& ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_KanbanBoard_vue_vue_type_style_index_0_id_2cc81914_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=style&index=0&id=2cc81914&scoped=true&lang=css&");
...
/***/ "./resources/js/pages/KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true&":
/*!***************************************************************************************!*\
  !*** ./resources/js/pages/KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true& ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_KanbanBoard_vue_vue_type_template_id_2cc81914_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_KanbanBoard_vue_vue_type_template_id_2cc81914_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_KanbanBoard_vue_vue_type_template_id_2cc81914_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true&");
      ...
      _c("div", { staticClass: "card-body" }, [
        _c("form", [
          _c("div", { staticClass: "mb-3" }, [
            _c(
              "label",
              { staticClass: "form-label", attrs: { for: "dateDelivery" } },
              [_vm._v("Enter a title")]
            ),
            _vm._v(" "),
            _c("input", {
              directives: [
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.newTask.date_delivery,
                  expression: "newTask.date_delivery",
                },
              ],
              staticClass: "form-control",
              attrs: { type: "date", id: "dateDelivery" },
              domProps: { value: _vm.newTask.date_delivery },
              on: {
                input: function ($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.newTask, "date_delivery", $event.target.value)
                },
              },
            }),
          ]),
            ...
            : _c(
                "button",
                {
                  ...
                  on: {
                    click: function ($event) {
                      $event.preventDefault()
                      return _vm.handleUpdateTask.apply(null, arguments)
                    },
                  },
                },
                [_vm._v("\n          Update\n        ")]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/KanbanBoard.vue?vue&type=template&id=2cc81914&scoped=true& ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "card shadow-md" }, [
      _c("div", { staticClass: "card-header text-center fw-bolder fs-3" }, [
        _vm._v("Kanban Board"),
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "card-body" }, [
        _c(
          ...
          _vm._l(_vm.statuses, function (status) {
            return _c("div", { key: status.slug, staticClass: "col" }, [
              _c(
                "div",
                { staticClass: "card shadow bg-body rounded" },
                [
                  _c(
                    "div",
                    {
                      staticClass:
                        "card-header fw-bolder d-flex justify-content-between",
                    },
                    [
                      ...
                      _c(
                        ...
                        _vm._l(status.tasks, function (task) {
                          return _c(
                            ...
                            {
                              key: task.id,
                              staticClass: "card-body card-draggable",
                              on: {
                                click: function ($event) {
                                  $event.preventDefault()
                                  return _vm.openEditTaskForm(task)
                                },
                              },
                            },
                            [
                  ...
                  _vm._v(" "),
                  !status.tasks.length && _vm.newTaskForStatus !== status.id
                    ? _c("div", { staticClass: "card-body" }, [_vm._m(0, true)])
                    : _vm._e(),
                ],
                1
              ),
    ...
    return _c("div", { staticClass: "card" }, [
      _c("div", { staticClass: "card-body" }, [
        _c("div", { staticClass: "row d-flex justify-content-center" }, [
          _c(
            "h5",
            { staticClass: "card-title text-center text-warning mb-0" },
            [
              _vm._v(
                "\n                      No tasks yet\n                    "
              ),
